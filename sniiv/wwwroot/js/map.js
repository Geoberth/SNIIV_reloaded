...
function loadMenu() {
    $('.sidebar-left .slide-submenu').on('click', hideMenu);
    $('.mini-submenu-left').on('click', showMenu);
...
$(function () {
    ...
    var wmsSourceIndigenas = new ol.source.TileWMS({
        ...
        url: 'https://ide.sedatu.gob.mx' + ':8080/wms',
        params: {
            ...
            'WIDTH': '256',
            'HEIGHT': '256',
            'BBOX': '- 117.124268879605, 14.8576995952602, - 86.710452794800, 32.71865357005596 ',
